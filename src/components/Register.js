...
export default function Register() {
    return (
        <div>
            <div className="home1">
                <h2 className="t4"><em>PIZZA SHOPEE REGISTER</em></h2>     
            </div>
			<div className="card1">
				<form>
					<h2 className="title1"> Log in</h2>
					<p className="subtitle">Don't have an account? <Link to="/login"><a href="#"> sign In</a></Link></p>
					...
					<div className="email-login">
						...
						<input type="text" placeholder="Enter Email" name="uname" autoComplete="off" required/>
